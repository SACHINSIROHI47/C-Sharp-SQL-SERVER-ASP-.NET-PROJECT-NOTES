        ...
        private void btnFind_Click(object sender, EventArgs e)
            ...
            else
            {
                ...
                if (reader.HasRows == true)
                {
                    ...
                    cmbAccountNumber.Text = Convert.ToString(reader["ACNO"]);
                    cmbTransactionType.Text = Convert.ToString(reader["TRAN_TYPE"]);
                    ...
                    dtpTransactionDate.Text = Convert.ToString(reader["TRAN_DATE"]);
                }
                else
                {
                    MessageBox.Show("Record did not Find", "Error Message");
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    ///Add TRANSACTION_ID IN Combobox
                    String str2 = "SELECT TRAN_ID FROM TRANSACTIONS ORDER BY TRAN_ID ASC";
                    SqlCommand cmd2 = new SqlCommand(str2, con);
                    cmd2.CommandType = CommandType.Text;
                    ...
                    MessageBox.Show("Record has been deleted in Transaction Table", "Message");
                }
                catch (Exception e1)
                {
                    MessageBox.Show("Exception : " + e1.Message.ToString());
