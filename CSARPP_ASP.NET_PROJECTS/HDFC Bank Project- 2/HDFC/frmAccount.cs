            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        ...
                        String str = "insert ACCOUNTS(ACNO,ACCOUNT_TYPE,FIRST_NAME,LAST_NAME,ADDRESS,STATE,CITY,DATE_OF_BIRTH,OPENING_DATE,PHONE_NO,BALANCE,AC_IMAGE) values(@acno,@actype,@first_name,@last_name,@address,@state,@city,@dateofbirth,@opdate,@phoneno,@balance,@acimage)";
