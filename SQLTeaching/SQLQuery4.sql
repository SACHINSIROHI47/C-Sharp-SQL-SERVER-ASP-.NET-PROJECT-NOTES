...
DROP INDEX AC COUNTS.INDEX_ACNO
...
INSERT ACCOUNTS(ACNO,FIRST_NAME,LAST_NAME,AC_TYPE)
VALUES('A00003','VINITA','JAIN','CURRENT')

INSERT ACCOUNTS(ACNO,FIRST_NAME,LAST_NAME,AC_TYPE)
VALUES('A00004','VINITA','JAIN','NOTHING')

INSERT ACCOUNTS(ACNO,FIRST_NAME,LAST_NAME,BALANCE,AC_TYPE)
VALUES('T00001','VINITA','JAIN',2000.00,'SAVING')

INSERT ACCOUNTS(ACNO,FIRST_NAME,LAST_NAME,BALANCE,AC_TYPE)
VALUES('A006','AJAY','SHARMA',5000.00,'SAVING')
...
INSERT TRANSACTIONS(TRAN_ID,ACNO,AMOUNT,TRAN_DATE,TRAN_TYPE)
VALUES('T0000002','A00009',2000.00,'04/16/2015','DEPOSIT')

INSERT TRANSACTIONS(TRAN_ID,ACNO,AMOUNT,TRAN_TYPE)
VALUES('T0000002','A00001',2000.00,'DEPOSIT')
...
INSERT TRANSACTIONS(TRAN_ID,ACNO,AMOUNT,TRAN_DATE,TRAN_TYPE)
VALUES('T0000003','A00002',500.00,'04/16/2015','WITH')
...
(
ACNO CHAR(6) NOT NULL CONSTRAINT PK_ACNO PRIMARY KEY CLUSTERED
CONSTRAINT CHECK_ACNO CHECK(ACNO LIKE 'A[0-9][0-9][0-9][0-9][0-9]' OR ACNO IN('SA0001','MA0002','ST0003')),
FIRST_NAME VARCHAR(15) NOT NULL,
LAST_NAME VARCHAR(15) NOT NULL,
BALANCE MONEY NOT NULL DEFAULT  5000,
AC_TYPE VARCHAR(15) CONSTRAINT CHECK_AC_TYPE CHECK(AC_TYPE IN('SAVING','CURRENT')) 
...
INSERT ACCOUNTS(ACNO,FIRST_NAME,LAST_NAME,BALANCE,AC_TYPE)
VALUES('MA0002','JOY','JULIAN',9000.00,'CURRENT')

INSERT ACCOUNTS(ACNO,FIRST_NAME,LAST_NAME,AC_TYPE)
VALUES('ST0003','VINITA','JAIN','CURRENT')
...
ROOOM_NO INT
CONSTRAINT PK_ROLL_NO_COURSE_CODE PRIMARY KEY(ROLL_NO,COURSE_CODE))

INSERT EXAMINATIONS(ROLL_NO,COURSE_CODE,ROOOM_NO)
VALUES('R0001','C002',4)
...
COURSE_CODE CHAR(4),
MARKS INT,
EVALUATER VARCHAR(40)
CONSTRAINT PK_ROLL_NO_COURSE_CODE_MARKS PRIMARY KEY
CONSTRAINT FK_ROLL_NO_COURSE_CODE FOREIGN KEY REFERENCES EXAMINATIONS(ROLL_NO,COURSE_CODE)
)
